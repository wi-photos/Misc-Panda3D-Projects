...
def createEffect(values):
    ...
    blend_gradient=loader.loadTexture("data/vfx/blend.png", minfilter=Texture.FTNearest, magfilter=Texture.FTNearest)
    ...
    for geom in p.findAllMatches('**/+GeomNode'):       
        ...
        geom.setShader(Shader.load(Shader.SLGLSL, "data/shaders/vfx_v.glsl","data/shaders/vfx_f.glsl"), 1)
...
def loadValues(v, p):
    ...
    # Sprite parameters
    p0.renderer.addTextureFromFile('data/vfx/smoke1.png') #some default must be added or it bugs out
